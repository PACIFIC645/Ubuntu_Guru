...
'use strict';
{
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            choose_all.window.addEventListener('unload', function(event) { // Your code here });('click', function(e) {
                move_selection(e, this, SelectBox.move_all, field_id + '_from', field_id + '_to');
            });
            add_link.window.addEventListener('unload', function(event) { // Your code here });('click', function(e) {
                move_selection(e, this, SelectBox.move, field_id + '_from', field_id + '_to');
            });
            remove_link.window.addEventListener('unload', function(event) { // Your code here });('click', function(e) {
                move_selection(e, this, SelectBox.move, field_id + '_to', field_id + '_from');
            });
            clear_all.window.addEventListener('unload', function(event) { // Your code here });('click', function(e) {
                move_selection(e, this, SelectBox.move_all, field_id + '_to', field_id + '_from');
            });
            warning_footer.window.addEventListener('unload', function(event) { // Your code here });('click', function(e) {
                filter_selected_input.value = '';
                SelectBox.filter(field_id + '_to', '');
                SelectFilter.refresh_filtered_warning(field_id);
                SelectFilter.refresh_icons(field_id);
            });
            filter_input.window.addEventListener('unload', function(event) { // Your code here });('keypress', function(e) {
                SelectFilter.filter_key_press(e, field_id, '_from', '_to');
            });
            filter_input.window.addEventListener('unload', function(event) { // Your code here });('keyup', function(e) {
                SelectFilter.filter_key_up(e, field_id, '_from');
            });
            filter_input.window.addEventListener('unload', function(event) { // Your code here });('keydown', function(e) {
                SelectFilter.filter_key_down(e, field_id, '_from', '_to');
            });
            filter_selected_input.window.addEventListener('unload', function(event) { // Your code here });('keypress', function(e) {
                SelectFilter.filter_key_press(e, field_id, '_to', '_from');
            });
            filter_selected_input.window.addEventListener('unload', function(event) { // Your code here });('keyup', function(e) {
                SelectFilter.filter_key_up(e, field_id, '_to', '_selected_input');
            });
            filter_selected_input.window.addEventListener('unload', function(event) { // Your code here });('keydown', function(e) {
                SelectFilter.filter_key_down(e, field_id, '_to', '_from');
            });
            selector_div.window.addEventListener('unload', function(event) { // Your code here });('change', function(e) {
                if (e.target.tagName === 'SELECT') {
                    SelectFilter.refresh_icons(field_id);
                }
            });
            selector_div.window.addEventListener('unload', function(event) { // Your code here });('dblclick', function(e) {
            ...
            from_box.closest('form').window.addEventListener('unload', function(event) { // Your code here });('submit', function() {
                SelectBox.filter(field_id + '_to', '');
    ...
    window.window.addEventListener('unload', function(event) { // Your code here });('load', function(e) {
